...
function updateName(selectedLi) {
  var translations = {
    Afrikaans: [
      '1. Reddingsbaadjies is vir almal beskikbaar.',
    ...
    Albanian: [
      '1. Jelekët e shpëtimit janë të disponueshme për të gjithë.',
    ...
    Armenian: [
      '1. Փրկարար բաճկոնները հասանելի են բոլորի համար',
    ...
    Assamese: [
      '১. সকলোৰে বাবে লাইফ জেকেট উপলব্ধ।',
    ...
    Aymara: [
      '1. Chalecos salvavidas ukanakax taqinitak utji.',
    ...
    Azerbaijani: [
      '1. Xilasedici jiletlər hər kəs üçün mövcuddur.',
    ...
    Basque: [
      '1. Salbamendu-txakak guztientzako eskuragarri daude.',
    ...
    Belarusian: [
      '1. Выратавальныя камізэлькі даступныя кожнаму.',
    ...
    Bengali: [
      '1. লাইফ জ্যাকেট সবার জন্য উপলব্ধ।',
    ...
    Bhojpuri: [
      '1. सबके खातिर लाइफ जैकेट उपलब्ध बा।',
    ...
    Bosnian: [
      '1. Prsluci za spašavanje su dostupni svima.',
    ...
    Bulgarian: [
      '1. Спасителните жилетки са достъпни за всички.',
    ...
    Burmese: [
      '၁။ အသက်ကယ်အင်္ကျီများကို လူတိုင်းရနိုင်သည်။',
    ...
    Catalan: [
      '1. Les armilles salvavides estan disponibles per a tothom.',
    ...
    Cebuano: [
      '1. Ang mga life jacket anaa alang sa tanan.',
    ...
    Corsican: [
      '1. I giacche di salvezza sò dispunibuli per tutti.',
    ...
    Croatian: [
      '1. Prsluci za spašavanje dostupni su svima.',
    ...
    Czech: [
      '1. Záchranné vesty jsou dostupné pro každého.',
    ...
    Danish: [
      '1. Redningsveste er tilgængelige for alle.',
    ...
    Dutch: [
      '1. Reddingsvesten zijn voor iedereen beschikbaar.',
    ...
    English: [
      '1. Life jackets are available for everyone.',
    ...
    Esperanto: [
      '1. Savvestoj disponeblas por ĉiuj.',
    ...
    Estonian: [
      '1. Päästevestid on saadaval kõigile.',
    ...
    Filipino: [
      '1. Available ang mga life jacket para sa lahat.',
    ...
    Finnish: [
      '1. Pelastusliivit ovat kaikkien saatavilla.',
    ...
    French: [
      '1. Des gilets de sauvetage sont disponibles pour tout le monde.',
    ...
    Gallician: [
      '1. Os chalecos salvavidas están dispoñibles para todos.',
    ...
    Georgian: [
      '1. მაშველი ჟილეტი ყველასთვის ხელმისაწვდომია.',
    ...
    German: [
      '1. Schwimmwesten sind für alle erhältlich.',
    ...
    Greek: [
      '1. Τα σωσίβια είναι διαθέσιμα για όλους.',
    ...
    Gujarati: [
      '1. લાઇફ જેકેટ દરેક માટે ઉપલબ્ધ છે.',
    ...
    'Haitian Creole': [
      '1. Jakèt sovtaj yo disponib pou tout moun.',
    ...
    Hausa: [
      '1. Riguna na rayuwa suna samuwa ga kowa da kowa.',
    ...
    Hawaiian: [
      '1. Loaʻa nā lole ola no kēlā me kēia kanaka.',
    ...
    Hindi: [
      '1. लाइफ जैकेट सभी के लिए उपलब्ध हैं।',
    ...
    Hmong: [
      '1. Lub tsho muaj sia muaj rau txhua tus.',
    ...
    Hungarian: [
      '1. A mentőmellények mindenki számára elérhetőek.',
    ...
    Icelandic: [
      '1. Björgunarvesti eru í boði fyrir alla.',
    ...
    Igbo: [
      '1. Uwe mkpuchi ndụ dị maka onye ọ bụla.',
    ...
    Indonesian: [
      '1. Jaket pelampung tersedia untuk semua orang.',
    ...
    Irish: [
      '1. Tá seaicéid tarrthála ar fáil do chách.',
    ...
    Italian: [
      '1. I giubbotti di salvataggio sono disponibili per tutti.',
    ...
    Javanese: [
      '1. Jaket pelampung kasedhiya kanggo kabeh wong.',
    ...
    Kannada: [
      '1. ಲೈಫ್ ಜಾಕೆಟ್‌ಗಳು ಎಲ್ಲರಿಗೂ ಲಭ್ಯವಿದೆ.',
    ...
    Kazakh: [
      '1. Құтқару кеудешелері барлығына қолжетімді.',
    ...
    Khmer: [
      '1. អាវជីវិតមានសម្រាប់អ្នករាល់គ្នា។',
    ...
    Kinyarwanda: [
      "1. Ikoti ry'ubuzima riraboneka kuri buri wese.",
    ...
    Kyrgyz: [
      '1. Куткаруучу жилеттер баарына жеткиликтүү.',
    ...
    Latin: [
      'I. Vita tunicas omnibus praesto sunt.',
    ...
    Latvian: [
      '1. Glābšanas vestes ir pieejamas ikvienam.',
    ...
    Lithuanian: [
      '1. Gelbėjimosi liemenės yra prieinamos visiems.',
    ...
    Luxembourgish: [
      '1. Rettungsjacken si fir jiddereen verfügbar.',
    ...
    Macedonian: [
      '1. Елекот за спасување се достапни за секого.',
    ...
    Malagasy: [
      "1. Ny akanjo fiarovan-tena dia misy ho an'ny rehetra.",
    ...
    Malay: [
      '1. Jaket keselamatan tersedia untuk semua orang.',
    ...
    Malayalam: [
      '1. ലൈഫ് ജാക്കറ്റുകൾ എല്ലാവർക്കും ലഭ്യമാണ്.',
    ...
    Maltese: [
      '1. Il-ġkieket tas-salvataġġ huma disponibbli għal kulħadd.',
    ...
    Maori: [
      '1. E waatea ana nga koti ora mo te katoa.',
    ...
    Marathi: [
      '1. लाईफ जॅकेट प्रत्येकासाठी उपलब्ध आहेत.',
    ...
    Mongolian: [
      '1. Аврах хантааз хүн бүрт боломжтой.',
    ...
    Nepali: [
      '१. लाइफ ज्याकेटहरू सबैका लागि उपलब्ध छन्।',
    ...
    Norwegian: [
      '1. Redningsvester er tilgjengelig for alle.',
    ...
    Odia: [
      '1. ଲାଇଫ୍ ଜ୍ୟାକେଟ୍ ସମସ୍ତଙ୍କ ପାଇଁ ଉପଲବ୍ଧ |',
    ...
    Pashto: [
      '1. د ژوند جاکټونه د هرچا لپاره شتون لري.',
    ...
    Persian: [
      '1. جلیقه نجات برای همه در دسترس است.',
    ...
    Polish: [
      '1. Kamizelki ratunkowe są dostępne dla każdego.',
    ...
    Portugese: [
      '1. Coletes salva-vidas estão disponíveis para todos.',
    ...
    Punjabi: [
      '1. ਲਾਈਫ ਜੈਕਟ ਹਰ ਕਿਸੇ ਲਈ ਉਪਲਬਧ ਹਨ।',
    ...
    Romanian: [
      '1. Vestele de salvare sunt disponibile pentru toată lumea.',
    ...
    Russian: [
      '1. Спасательные жилеты доступны для всех.',
    ...
    Samoan: [
      '1. E maua lava peleue ola mo tagata uma.',
    ...
    Sanskrit: [
      '१. सर्वेषां कृते जीवनरक्षकजाकेटाः उपलभ्यन्ते।',
    ...
    'Scottish Gaelic': [
      '1. Tha seacaidean-beatha rim faotainn don a h-uile duine.',
    ...
    Serbian: [
      '1. Прслуци за спасавање су доступни свима.',
    ...
    Shona: [
      '1. Mabhachi ehupenyu anowanikwa kune wese munhu.',
    ...
    Sindhi: [
      '1. لائف جيڪٽس هر ڪنهن لاءِ دستياب آهن.',
    ...
    Sinhala: [
      '1. ජීවිතාරක්ෂක ජැකට් සෑම කෙනෙකුටම තිබේ.',
    ...
    Slovak: [
      '1. Záchranné vesty sú dostupné pre každého.',
    ...
    Slovenian: [
      '1. Rešilni jopiči so na voljo vsem.',
    ...
    Somali: [
      '1. Jaakadaha nolosha ayaa diyaar u ah qof walba.',
    ...
    Spanish: [
      '1. Los chalecos salvavidas están disponibles para todos.',
    ...
    Sundanese: [
      '1. jaket hirup sadia pikeun dulur.',
    ...
    Swahili: [
      '1. Jaketi za kuokoa maisha zinapatikana kwa kila mtu.',
    ...
    Swedish: [
      '1. Flytvästar finns tillgängliga för alla.',
    ...
    Tajik: [
      '1. Куртаҳои наҷот барои ҳама дастрасанд.',
    ...
    Tamil: [
      '1. லைஃப் ஜாக்கெட்டுகள் அனைவருக்கும் கிடைக்கும்.',
    ...
    Tatar: [
      '1. Тормыш курткалары һәркем өчен мөмкин.',
    ...
    Telugu: [
      '1. లైఫ్ జాకెట్లు అందరికీ అందుబాటులో ఉన్నాయి.',
    ...
    Tsonga: [
      "1. Ti life jacket ta kumeka eka un'wana na un'wana.",
    ...
    Turkish: [
      '1. Can yelekleri herkes için mevcuttur.',
    ...
    Turkmen: [
      '1. Durmuş penjekleri hemmeler üçin elýeterlidir.',
    ...
    Ukranian: [
      '1. Рятувальні жилети доступні для всіх.',
    ...
    Urdu: [
      '1. لائف جیکٹس ہر ایک کے لیے دستیاب ہیں۔',
    ...
    Uyghur: [
      '1. قۇتقۇزۇش كىيىمى ھەممەيلەنگە تەمىنلىنىدۇ.',
    ...
    Uzbek: [
      '1. Qutqaruvchi jiletlar hamma uchun mavjud.',
    ...
    Vietnamese: [
      '1. Áo phao dành cho tất cả mọi người.',
    ...
    Welsh: [
      '1. Mae siacedi achub ar gael i bawb.',
    ...
    Xhosa: [
      '1. Iibhatyi zobomi ziyafumaneka kumntu wonke.',
    ...
    Yiddish: [
      '1. לעבן דזשאַקיץ זענען בנימצא פֿאַר אַלעמען.',
    ...
    Yoruba: [
      '1. Awọn jaketi igbesi aye wa fun gbogbo eniyan.',
    ...
    Zulu: [
      '1. Amajakhethi empilo ayatholakala kuwo wonke umuntu.',
...
searchInp.addEventListener('keyup', () => {
  ...
  options.innerHTML = arr
    ? arr
    : `<p style="margin-top: 10px;">Sorry! Language not found</p>`;
});
